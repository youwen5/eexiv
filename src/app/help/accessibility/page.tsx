  ...
  return (
    <div className='content text-slate-800'>
      ...
      <p>
        ...
        low-spec devices and it can only get worse.{' '}
        <span className='line-through'>
          If you would like to remedy this issue, we again recommend you open a{' '}
          <a href='https://github.com/youwen5/eeXiv/pull/new'>pull request</a>{' '}
          and port our in memory database to an actual remote database.
        </span>
      </p>
      <p>
        Again, we reiterate that this is now an intended feature. If your
        hardware cannot handle our awesome architecture, you should purchase a
        new American-made computer powered by American chips.
      </p>
    </div>
  )
}
